def middle_grades(some_list, some_course=None):
...
print(f'Средня оценка студентов за курс Python = '
      f'{middle_grades(list_student, "Python"):.1f}')
print(f'Средняя оценка лекторов за курс Python = '
      f'{middle_grades(list_lecturer, "Python"):.1f}')
